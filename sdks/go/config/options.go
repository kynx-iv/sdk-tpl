...
// Config holds all configuration for the SdkTpl client.
type Config struct {
	// APIKey is the primary API key for authentication.
	APIKey string

	// BaseURL is the base URL of the SdkTpl API.
	BaseURL string
...
// Option is a functional option for configuring the SdkTpl client.
