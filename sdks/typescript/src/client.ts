 ...
 */
export class SdkTplClient {
  protected readonly http: HttpClient;
  protected readonly logger: Logger;
  private readonly config: SdkTplConfig;

  constructor(config: SdkTplConfig) {
    if (!config.apiKey) {
   ...
   */
  getConfig(): Readonly<
    Omit<SdkTplConfig, 'apiKey' | 'secondaryApiKey'>
  > {
