...
module SdkTpl
  # Main client for the SdkTpl Ruby SDK.
  #
  ...
  class Client
    ...
    # Creates a new SdkTpl API client.
    #
    ...
    # @raise [SdkTplError] if the API key is missing or blank
    def initialize(
      api_key:,
      base_url: nil,
      timeout: 30,
      ...
      raise SdkTplError.auth_missing_key("API key is required") if api_key.nil? || api_key.strip.empty?
    ...
    # Performs a health check against the SdkTpl API.
    #
    ...
    # @raise [SdkTplError] on network or authentication failures
    def health_check
