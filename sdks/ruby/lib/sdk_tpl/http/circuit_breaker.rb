...
module SdkTpl
  module Http
    ...
    class CircuitBreaker
      ...
      # @raise [SdkTplError] with code CIRCUIT_OPEN when the circuit is open
      def execute(&block)
      ...
      def check_state_and_admit
        ...
        when OPEN
          ...
          if elapsed >= @reset_timeout
            ...
            raise SdkTplError.circuit_open_error(retry_after: retry_after)
          end
      ...
      def check_half_open_admission
        if @half_open_attempts >= @half_open_requests
          raise SdkTplError.circuit_open_error(retry_after: @reset_timeout)
        end
