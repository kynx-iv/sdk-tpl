using {{SDK_SLUG_PASCAL}}.Sdk;
using {{SDK_SLUG_PASCAL}}.Sdk.Errors;
using {{SDK_SLUG_PASCAL}}.Sdk.Http;
using Xunit;

namespace {{SDK_SLUG_PASCAL}}.Sdk.Tests;
...
public class CircuitBreakerTests
{
    ...
    public async Task Execute_ShouldThrow_WhenCircuitIsOpen()
    {
        ...
        var ex = await Assert.ThrowsAsync<SdkTplException>(
