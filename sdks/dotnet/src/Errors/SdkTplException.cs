namespace SdkTpl.Sdk.Errors;

/// <summary>
/// Base exception for all {{SDK_NAME}} SDK errors.
/// </summary>
public class SdkTplException : Exception
{
    ...
    /// </summary>
    public static SdkTplException NetworkError(string message, Exception? inner = null) =>
        new(message, ErrorCode.NetworkError, recoverable: true, innerException: inner);

    /// <summary>
    /// Creates a timeout error exception.
    /// </summary>
    public static SdkTplException TimeoutError(string message, Exception? inner = null) =>
        new(message, ErrorCode.Timeout, recoverable: true, innerException: inner);

    /// <summary>
    /// Creates an authentication error exception.
    /// </summary>
    public static SdkTplException AuthenticationError(string message, int? statusCode = 401) =>
    ...
    /// </summary>
    public static SdkTplException KeyRotationError(string message, int? statusCode = 401) =>
        new(message, ErrorCode.KeyRotationFailed, statusCode: statusCode, recoverable: true);

    /// <summary>
    /// Creates a rate-limited error exception.
    /// </summary>
    public static SdkTplException RateLimited(string message, long? retryAfter = null) =>
