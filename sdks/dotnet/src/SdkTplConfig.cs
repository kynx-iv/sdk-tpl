...
/// </summary>
public record SdkTplConfig
{
    /// <summary>Primary API key for authentication.</summary>
    public required string ApiKey { get; init; }

    /// <summary>Base URL for API requests. Resolved from {{ENV_MODE_VAR}} if not set.</summary>
    ...
    public ISdkTplLogger? Logger { get; init; }

    private static string ResolveBaseUrl()
    {
        var mode = Environment.GetEnvironmentVariable("{{ENV_MODE_VAR}}");
